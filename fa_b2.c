  ...
  do {
	...
	*b++ = c;
	...
	err_goto(nc, -3, out)
      ...
      state = B2_2BIT_INIT;
    case B2_2BIT0:
      *b++ = b6(uc, deoxy, b2toa, (c >> 5) & 6);
      if ((++i % linelen) == 0)
	*b++ = '\n';
    case B2_2BIT3:
      *b++ = b6(uc, deoxy, b2toa, (c >> 3) & 6);
      if ((++i % linelen) == 0)
	*b++ = '\n';
    case B2_2BIT2:
      *b++ = b6(uc, deoxy, b2toa, (c >> 1) & 6);
      if ((++i % linelen) == 0)
	*b++ = '\n';
    case B2_2BIT1:
      *b++ = b6(uc, deoxy, b2toa, (c << 1) & 6);
...
FILE *
getfp(const char *fname, unsigned *mode)
{
